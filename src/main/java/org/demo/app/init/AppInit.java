...
public class AppInit {
	...
	public static void main(String[] args) throws Exception {
		...
		Connection connection = rabbitBroker.newConnection("INIT connection");
		...
		System.out.println("Declaring exchange(s)...");
		// exchangeDeclare 
		// Parameters:
		...
		System.out.println("Declaring queue(s)...");
		// Parameters:
		...
		System.out.println("Declaring bindings(s)...");
		// Parameters :
		// . queue the name of the queue
		// . exchange the name of the exchange
